<div id="customization-app" style="margin: 20px 0;">
    <button
        ...
        onclick="var d=document.getElementById('customization-dialog');d.style.display='flex';document.body.style.overflow='hidden';if(window.loadPrintAreas)window.loadPrintAreas();"
...
<div id="customization-dialog" class="fixed inset-0 bg-black bg-opacity-50" style="display: none; z-index: 99999;">
    <div class="bg-white rounded-lg shadow-xl" style="width: 90%; max-width: 1200px; height: 80vh; margin: 5vh auto; display: flex; flex-direction: column;">
        <div class="flex justify-between items-center p-4 border-b" style="background: #f9fafb;">
            ...
            <button id="close-dialog" onclick="document.getElementById('customization-dialog').style.display='none'; document.body.style.overflow='';" style="padding: 8px 16px; background: #e5e7eb; border: none; border-radius: 6px; cursor: pointer;">Close</button>
        </div>
