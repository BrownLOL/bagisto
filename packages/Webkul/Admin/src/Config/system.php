...
return [
    ...
    [
        ...
        'key' => 'sales.payment_methods.alipay',
        'name' => 'admin::app.configuration.index.sales.payment-methods.alipay',
        'info' => 'admin::app.configuration.index.sales.payment-methods.alipay-info',
        'sort' => 1,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'app_id',
                'title' => 'admin::app.configuration.index.sales.payment-methods.app-id',
                'type' => 'text',
                'depends' => 'active:1,sandbox:0',
                'info' => 'admin::app.configuration.index.sales.payment-methods.production-mode-info',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'private_key',
                'title' => 'admin::app.configuration.index.sales.payment-methods.private-key',
                'type' => 'textarea',
                'depends' => 'active:1,sandbox:0',
                'info' => 'admin::app.configuration.index.sales.payment-methods.production-mode-info',
                'channel_based' => true,
                ...
                'name' => 'public_key',
                'title' => 'admin::app.configuration.index.sales.payment-methods.public-key',
                'type' => 'textarea',
                'depends' => 'active:1,sandbox:0',
                'info' => 'admin::app.configuration.index.sales.payment-methods.production-mode-info',
                'channel_based' => true,
                ...
                'name' => 'test_app_id',
                'title' => 'admin::app.configuration.index.sales.payment-methods.test-app-id',
                'type' => 'text',
                ...
                'title' => 'admin::app.configuration.index.sales.payment-methods.test-private-key',
                'type' => 'textarea',
                'depends' => 'active:1,sandbox:1',
                'info' => 'admin::app.configuration.index.sales.payment-methods.test-mode-info',
                'channel_based' => true,
                ...
                'title' => 'admin::app.configuration.index.sales.payment-methods.test-public-key',
                'type' => 'textarea',
                'depends' => 'active:1,sandbox:1',
                'info' => 'admin::app.configuration.index.sales.payment-methods.test-mode-info',
                'channel_based' => true,
        ...
        'key' => 'sales.payment_methods.wechatpay',
        'name' => 'admin::app.configuration.index.sales.payment-methods.wechatpay',
        'info' => 'admin::app.configuration.index.sales.payment-methods.wechatpay-info',
        'sort' => 1,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'api_cert_path',
                'title' => 'admin::app.configuration.index.sales.payment-methods.api-cert-path',
                'type' => 'text',
                'depends' => 'active:1,sandbox:0',
                'info' => 'admin::app.configuration.index.sales.payment-methods.production-mode-info',
                'channel_based' => true,
                ...
                'name' => 'api_key_path',
                'title' => 'admin::app.configuration.index.sales.payment-methods.api-key-path',
                'type' => 'text',
                'depends' => 'active:1,sandbox:0',
                'info' => 'admin::app.configuration.index.sales.payment-methods.production-mode-info',
                'channel_based' => true,
                ...
                'title' => 'admin::app.configuration.index.sales.payment-methods.test-merchant-id',
                'type' => 'text',
                'depends' => 'active:1,sandbox:1',
                'info' => 'admin::app.configuration.index.sales.payment-methods.test-mode-info',
                'channel_based' => true,
                ...
                'name' => 'test_api_key',
                'title' => 'admin::app.configuration.index.sales.payment-methods.test-api-key',
                'type' => 'text',
                'depends' => 'active:1,sandbox:1',
                'info' => 'admin::app.configuration.index.sales.payment-methods.test-mode-info',
                'channel_based' => true,
                ...
                'name' => 'test_api_cert_path',
                'title' => 'admin::app.configuration.index.sales.payment-methods.test-api-cert-path',
                'type' => 'text',
                'depends' => 'active:1,sandbox:1',
                'info' => 'admin::app.configuration.index.sales.payment-methods.test-mode-info',
                'channel_based' => true,
                ...
                'name' => 'test_api_key_path',
                'title' => 'admin::app.configuration.index.sales.payment-methods.test-api-key-path',
                'type' => 'text',
                'depends' => 'active:1,sandbox:1',
                'info' => 'admin::app.configuration.index.sales.payment-methods.test-mode-info',
                'channel_based' => true,
